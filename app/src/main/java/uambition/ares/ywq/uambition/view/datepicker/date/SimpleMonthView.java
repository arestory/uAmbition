...
package uambition.ares.ywq.uambition.view.datepicker.date;
...
import uambition.ares.ywq.uambition.view.datepicker.Utils;
import uambition.ares.ywq.uambition.view.datepicker.date.SimpleMonthAdapter.CalendarDay;
import uambition.ares.ywq.uambition.view.datepicker.googlecode.TouchExplorationHelper;
...
public class SimpleMonthView extends View {
    ...
    public SimpleMonthView(Context context) {
        ...
        mTodayNumberColor = res.getColor(R.color.black);
        mMonthTitleColor = res.getColor(R.color.white);
        mTodayCircleColor= res.getColor(R.color.theme_color);
