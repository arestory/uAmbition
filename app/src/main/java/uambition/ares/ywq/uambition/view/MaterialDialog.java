...
public class MaterialDialog {
	...
	public MaterialDialog setPositiveButton(int resId,
		...
		mPositiveButton.setTextColor(Color.argb(255, 240, 104, 0));
...
//					WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
			...
			contv.setFocusable(false);
			contv.setFocusableInTouchMode(false);
			...
			int SCREEN_WIDTH = displayMetrics.widthPixels;// 初始化屏幕宽度
//			view2.setLayoutParams(new LayoutParams(SCREEN_WIDTH * 4 / 5,
